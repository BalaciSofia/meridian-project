        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlackLink = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredForAll = table.Column<bool>(type: "bit", nullable: false),
                    RequiredForDepartmentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentTypes_Departments_RequiredForDepartmentId",
                        column: x => x.RequiredForDepartmentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Accounts_CreatedByAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Accounts_CreatedByAccountId",
                        column: x => x.CreatedByAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reacts_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTypes_RequiredForDepartmentId",
                table: "DocumentTypes",
                column: "RequiredForDepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_CreatedByAccountId",
                table: "Events",
                column: "CreatedByAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_CreatedByAccountId",
                table: "Posts",
                column: "CreatedByAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Reacts_AccountId",
                table: "Reacts",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Reacts_PostId_AccountId",
                table: "Reacts",
